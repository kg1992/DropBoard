...
var format_notes_model = function(nm, out, click_event) {
...
var pull_note_list = function(dbx, path) {
...
//      }
//
var pull_note_content = function(dbx, path) {
    return new Promise(function(resolve, reject) {
...
var push_note_content = function(dbx, path, content) {
    return new Promise(function(resolve, reject) {
        dbx.filesUpload({
                path: path,
                contents: content,
...
var push_delete = function(dbx, path){
